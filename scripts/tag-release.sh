...
log_info "  1. Building binaries for ARM64 and x86_64"
log_info "  2. Building Qt GUI"
log_info "  3. Creating release tarball"
log_info "  4. Generating changelog"
log_info "  5. Creating GitHub release"
echo ""
