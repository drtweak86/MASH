# History for holy-loop-fedora.sh
Chosen master: **holy-loop-fedora-final.sh** (sha 71a4d74fd2b9)

## Variants
- holy-loop-fedora-final.sh (sha 71a4d74fd2b9)
- holy-loop-fedora.sh (sha 22ce50e4b512)
- holy-loop-fedora.sh (sha 22ce50e4b512)

## Diffs (against master)

### holy-loop-fedora.sh → holy-loop-fedora-final.sh

```diff
--- holy-loop-fedora.sh
+++ holy-loop-fedora-final.sh
@@ -1,84 +1,60 @@
 #!/usr/bin/env bash
 set -euo pipefail
